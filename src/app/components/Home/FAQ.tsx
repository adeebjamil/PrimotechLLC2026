        ...
        <section className="py-24 px-6 md:px-12 lg:px-24 bg-white">
            ...
            <div className="max-w-4xl mx-auto">
                ...
                <div className="text-center mb-20">
                    ...
                    <h2 className="text-5xl lg:text-6xl font-black text-[#001F3F] mb-6 tracking-tighter">
                ...
                {/* Footer CTA */}
                <div className="mt-20 text-center p-12 rounded-[3rem] bg-[#001F3F] relative overflow-hidden group">
