    ...
    <div className="w-full max-w-4xl mx-auto px-4 py-8 border-t border-gray-200 mt-12 mb-8 flex flex-col sm:flex-row items-center justify-between gap-6">
      ...
      <div className="flex items-center gap-4">
        ...
        <Link
          ...
          className="w-10 h-10 rounded-full flex items-center justify-center bg-gray-100 hover:bg-[#1877F2] hover:text-white text-gray-600 transition-all duration-300"
        ...
        <Link
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="w-10 h-10 rounded-full flex items-center justify-center bg-gray-100 hover:bg-[#1DA1F2] hover:text-white text-gray-600 transition-all duration-300"
        ...
        <Link
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="w-10 h-10 rounded-full flex items-center justify-center bg-gray-100 hover:bg-[#0A66C2] hover:text-white text-gray-600 transition-all duration-300"
