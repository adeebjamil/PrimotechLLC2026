        ...
        <>
            ...
            <div className="fixed top-0 left-0 right-0 z-[101] flex items-stretch h-[36px] overflow-hidden">
                ...
                <div className="bg-[#001F3F] flex-grow flex items-center relative overflow-hidden">
                    <div className="flex items-center gap-12 whitespace-nowrap animate-marquee-rtl py-2">
                        ...
                        <div className="flex items-center gap-12">
                            <span className="text-white text-sm font-semibold tracking-wide flex items-center gap-2.5">
                                <Image src="/greentick.png" alt="tick" width={18} height={18} className="object-contain shrink-0" />
                    ...
                    {/* Angle Cut Effect */}
                    <div className="absolute right-0 top-0 bottom-0 w-8 bg-[#001F3F] transform skew-x-[20deg] translate-x-4 z-10 hidden md:block"></div>
                </div>

                {/* Right Side: Yellow Contact Info */}
                <div className="bg-[#FFD700] flex items-center px-4 md:px-8 relative shrink-0 z-20">
                    <div className="flex items-center gap-4 md:gap-6 relative z-20 whitespace-nowrap">
                        <a href="mailto:sales@primotech-llc.com" className="text-[#001F3F] text-[11px] md:text-[13px] font-black hover:text-black transition-colors duration-200 flex items-center gap-2">
                            <svg className="w-3.5 h-3.5 md:w-4 md:h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2.5} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                            </svg>
                            sales@primotech-llc.com
                        </a>
                        <span className="text-[#001F3F]/20 font-black">|</span>
                        <a href="tel:+971528796664" className="text-[#001F3F] text-[11px] md:text-[13px] font-black hover:text-black transition-colors duration-200 flex items-center gap-2">
                            <svg className="w-3.5 h-3.5 md:w-4 md:h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            {isMobileMenuOpen && (
                <div className="md:hidden fixed inset-0 bg-white z-[90] overflow-y-auto">
                    <div className="p-6 pt-28 min-h-screen flex flex-col">
                        {/* Go Back Section */}
                                            ...
                                            return (
                                                ...
                                                >
                                                    <div className="flex items-center gap-5">
                                                        {isProductCat ? (
                                                            <div className="w-14 h-14 bg-white rounded-2xl flex items-center justify-center text-[#14C8D4] shadow-sm text-2xl">
