    ...
    return (
        <>
            ...
            <div className="fixed top-0 left-0 right-0 z-[101] flex items-stretch h-[36px] overflow-hidden">
                ...
                <div className="bg-[#001F3F] flex-grow flex items-center px-6 relative">
                    <div className="flex items-center gap-4">
                        <span className="text-white text-sm font-semibold tracking-wide flex items-center gap-2">
                            <span className="text-[#14C8D4]">★</span>
                ...
                <div className="bg-[#FFD700] flex items-center px-6 md:pl-12 relative">
                    <div className="flex items-center gap-6 relative z-20">
                        <a href="mailto:sales@primotech-llc.com" className="text-[#001F3F] text-[13px] font-black hover:text-black transition-colors duration-200 flex items-center gap-2">
                        ...
                        <a href="tel:+971528796664" className="text-[#001F3F] text-[13px] font-black hover:text-black transition-colors duration-200 flex items-center gap-2">
                            <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
